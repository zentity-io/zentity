...
public class JobTest {
    ...
    public void testMakeResolversClause() throws Exception {
        ...
        Map<String, Set<Object>> inputAttributes = new TreeMap<>();
        Set<Object> names = new TreeSet<>();
        Set<Object> streets = new TreeSet<>();
        Set<Object> cities = new TreeSet<>();
        Set<Object> states = new TreeSet<>();
        Set<Object> zips = new TreeSet<>();
        Set<Object> phones = new TreeSet<>();
